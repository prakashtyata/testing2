...
class YITH_YWRAQ_Cron {
    ...
    public function __construct() {
        ...
        if( get_option( 'ywraq_automate_send_quote' ) == 'yes' && '0' != get_option( 'ywraq_cron_time' ) ){
    ...
    public function ywraq_set_cron(){
        ...
        if ( ! wp_next_scheduled( 'ywraq_automatic_quote' ) &&  get_option( 'ywraq_automate_send_quote' ) == 'yes' && '0' != get_option( 'ywraq_cron_time' )   ) {
