...
if ( !class_exists( 'YITH_YWRAQ_Send_Email_Request_Quote_Customer' ) ) {
    ...
    class YITH_YWRAQ_Send_Email_Request_Quote_Customer extends WC_Email {
	    ...
	    public function trigger( $args ) {
		    ...
		    $this->heading = apply_filters( 'wpml_translate_single_string', $this->get_heading(), 'admin_texts_woocommerce_ywraq_email_customer_settings', '[woocommerce_ywraq_email_customer_settings]heading', $this->raq['lang'] );
		    $this->subject = apply_filters( 'wpml_translate_single_string', $this->get_subject(), 'admin_texts_woocommerce_ywraq_email_customer_settings', '[woocommerce_ywraq_email_customer_settings]subject', $this->raq['lang'] );
