...
if ( ! class_exists( 'YITH_YWRAQ_Mini_List_Quote_Widget' ) ) {
	...
	class YITH_YWRAQ_Mini_List_Quote_Widget extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'item_name' ); ?>"><?php _e( 'Item Name:', 'yith-woocommerce-request-a-quote' ) ?></label>
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'item_plural_name' ); ?>"><?php _e( 'Item Plural Name:', 'yith-woocommerce-request-a-quote' ) ?></label>
