...
<div class="wrap">
	...
	<h2><?php _e( 'Category exclusion list', 'yith-woocommerce-request-a-quote' ); ?></h2>
	...
	<form id="yith-add-exclusion-cat" method="POST">
		<input type="hidden" name="_nonce" value="<?php echo wp_create_nonce( 'yith_ywraq_add_exclusions_cat' ); ?>" />
		<label for="add_categories"><?php _e( 'Select categories to exclude', 'yith-woocommerce-request-a-quote' ); ?></label>
