...
<div class="wrap">
	...
	<h2><?php _e( 'Tag exclusion list', 'yith-woocommerce-request-a-quote' ); ?></h2>
	...
	?>
	<form id="yith-add-exclusion-tag" method="POST">
		<input type="hidden" name="_nonce" value="<?php echo wp_create_nonce( 'yith_ywraq_add_exclusions_tag' ); ?>" />
		<label for="add_tags"><?php _e( 'Select tags to exclude', 'yith-woocommerce-request-a-quote' ); ?></label>
		<?php
