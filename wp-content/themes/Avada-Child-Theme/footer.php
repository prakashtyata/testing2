...
<script>
	jQuery(document).ready(function(){
			var finallist = "";
			jQuery(".page-id-2521 .shop_table tbody tr.cart_item").each(function() {
  				var name = jQuery(this).find(".product-name a").text();
  				var quantity = jQuery(this).find(".product-quantity .qty").val();
				namelist = "Product Name:" + name + "and  Quantity: " +  quantity + "<br>";
				finallist = finallist + namelist
			});
			finallist = finallist + "";
		jQuery(".list_area").val(finallist);
	});
